...
class MultiHeadedAttention(nn.Module):
    ...
    def forward(self, key, value, query, mask=None,similarity=None,
                layer_cache=None, type=None, predefined_graph_1=None): #similarity=None sau mask
        """
        ...
        if similarity is not None:
            ...
            similarity = similarity.to('cuda:0')
            scores = torch.mul(scores, similarity.float())
